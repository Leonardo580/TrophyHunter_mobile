...
public class CommentForm extends BaseForm{
    public CommentForm(Resources res) {
        ...
        CommentsService cs=CommentsService.getInstance();
     ArrayList<Comment> commentss=  cs.getAllComments();
...
private void addButton(String comment,Image img, int likeCount,int idnews) {
       ...
       Label Cont = new Label( " Comment  ", "NewsBottomLine");
       Cont.setTextPosition(RIGHT);
