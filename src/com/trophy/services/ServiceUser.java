...
public class ServiceUser {
    ...
    public void signup(TextField title, TextField EventTime, TextField Duration, Resources res) {
        ...
        String url = Statics.BASE_URL + "adduser?fullName=" + title.getText().toString() + "&email=" + EventTime.getText().toString() +
...
//             JsonNode jn=ob.readTree(Json);
            ...
            for(Map<String,Object> obj : list){
                ...
                c.setID_USER((int)Float.parseFloat(obj.get("id").toString()));
